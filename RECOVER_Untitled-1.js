...
lib.ssMetadata = [
		{name:"RECOVER_Untitled_1_atlas_", frames: [[1952,2042,1028,177],[3554,0,130,106],[3254,1065,640,692],[1952,0,1600,1063],[0,0,1950,2948],[1952,1065,1300,975]]}
];
...
(lib.כפתורבחר = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AjtD8IAAhMIEyAAIAAipQAAhEgPgjQgQgjgngVQgpgUhWgBQgeAAhAAHIgHhKQA/gKBHAAQCFAAA9A5QA8A7AAB2IAADAIBPAAIAABMg");
	this.shape.setTransform(54.8,-0.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AB/D8IAAkNQAAg3gMggQgLgeglgTQglgUhDAAQgoAAgyAHIAAGiIhZAAIAAnmQBkgQBVAAQBaAAA4AbQA4AaAYAuQAWAsAABRIAAEWg");
	this.shape_1.setTransform(0.2,-0.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("ABwD8IAAj1QAAhDgPgjQgOgigpgWQgqgVhJgBQgyABhFAIIgIhMQBIgKA9AAQCWgBA7A7QA7A7AAB1IAAEMg");
	this.shape_2.setTransform(-55.6,-0.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},1).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]},2).wait(1));

	// Layer 1
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#00CCFF").s().p("AwPF9IAAr5MAgfAAAIAAL5g");
	this.shape_3.setTransform(1,-1.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#0099FF").s().p("AwPF9IAAr5MAgfAAAIAAL5g");
	this.shape_4.setTransform(1,-1.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3}]}).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_4}]},2).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-103,-64.4,208.1,111.3);
...
}).prototype = getMCSymbolPrototype(lib.carecter, new cjs.Rectangle(-133.1,-59.9,246.1,98.9), null);
...
(lib.start = function(mode,startPosition,loop) {
	...
	this.but.setTransform(-48,2.1,0.299,0.287,0,0,0,0,0.1);
	new cjs.ButtonHelper(this.but, 0, 1, 2, false, new lib.כפתורבחר(), 3);

	this.timeline.addTween(cjs.Tween.get(this.but).wait(1));

	// Layer 1
	this.comboBox1 = new lib.an_ComboBox({'id': 'comboBox1', 'label':'', 'items':'dummy, dummy, items, 2, label, 0, , , data, 0, , , 3, בחר נושא, 0, חיות בישראל, 1, סרטים מישראל, 2', 'value':'0', 'disabled':false, 'visible':true, 'class':'ui-combobox'});

	this.comboBox1.setTransform(69,2,1,1,0,0,0,50,11);

	this.timeline.addTween(cjs.Tween.get(this.comboBox1).wait(1));

}).prototype = getMCSymbolPrototype(lib.start, new cjs.Rectangle(-78.7,-16.5,198.3,32), null);
...
(lib.end = function(mode,startPosition,loop) {
	...
	this.num.setTransform(-322.8,-225.8);
	...
	this.time.setTransform(-322.8,-178);
	...
	this.noT.setTransform(-231.1,-131.6);
	...
	this.yesT.setTransform(226.1,-131.6);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AgsAuIAFgPQAKAGAOAAQAQAAAMgJQAMgJAAgTQAAgRgJgKQgKgKgPAAQgIAAgIACIAAATQAAAMAMAAQAFAAADgCIACANQgFACgIAAQgNAAgHgGQgHgGAAgOIAAgeQARgFATgBQAVAAAQAOQAPANAAAaQAAAYgQAOQgQAPgaABQgTAAgMgIg");
	this.shape.setTransform(430.8,-161.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("A
6);

	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#000000").s().p("AgwA0IAAgPIA/AAIAAgjQAAgOgEgHQgDgHgIgFQgIgEgSAAIgTACIgCgQQANgCAPAAQAbAAAMAMQANAMAAAYIAAAoIARAAIAAAPg");
	this.shape_31.setTransform(98.6,-161.6);

	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#FF0000").s().p("AAAAJQgHAOgFAHIgMgIIAQgTIgXgEIAEgOQAQAFAHAEIgCgXIANAAIgCAXQAKgEANgFIAEAOQgMADgMABIARATIgMAIIgNgVg");
	this.shape_32.setTransform(83.7,-167.9);

	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#000000").s().p("AgXBJIAAgTQAAgTgCgXIgBgNQAAgZASgNIgoAAIAAggIBhAAIAAAbQgTAAgLAJQgMAIAAATIACANQADAaAAATIAAAXg");
	this.shape_33.setTransform(-275.6,-159.9);
	...
	this.shape_34.setTransform(-291.1,-160);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#000000").s().p("AgTBkIAAjHIAnAAIAADHg");
	this.shape_35.setTransform(-303.3,-157.1);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#000000").s().p("AglATIAAglIBLAAIAAAlg");
	this.shape_36.setTransform(-311.1,-159.9);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#000000").s().p("Ag3BJIAAgiIBAAAIhIhuIAqAAIAjA4QAGgCADgFQACgFABgWIABgWIAlAAIgCAWIAAANIgCAMQgCAHgEAFQgEAHgGAFQgGAFgJAEIAfAvIAAARg");
	this.shape_37.setTransform(-278,-207.7);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#000000").s().p("AgTApIAAhQIAnAAIAABQg");
	this.shape_38.setTransform(-288.4,-210.9);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#000000").s().p("AgTBJIAAiQIAnAAIAACQg");
	this.shape_39.setTransform(-296.1,-207.7);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#000000").s().p("AgTBkIAAjHIAnAAIAADHg");
	this.shape_40.setTransform(-303.7,-204.9);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#000000").s().p("AglATIAAglIBLAAIAAAlg");
	this.shape_41.setTransform(-311.5,-207.7);
	...
	this.nameGame.setTransform(192.5,-225.8);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#000000").s().p("Ag1A4QgVgWAAghQAAgiAUgUQAVgWAhAAQAXAAAQAKQAQAKAKAQQAKARAAAWQAAAggVAWQgVAWghAAQggAAgVgUgAgagfQgIAOgBARQAAAUAKAMQAKANAPAAQAQAAAJgNQALgMgBgUQABgTgLgNQgJgMgQABQgRgBgJANg");
	this.shape_42.setTransform(427.7,-207.7);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("#000000").s().p("AgTApIAAhQIAnAAIAABQg");
	this.shape_43.setTransform(415.2,-210.9);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("#000000").s().p("AgTApIAAhQIAnAAIAABQg");
	this.shape_44.setTransform(407.6,-210.9);
	...
	this.shape_45.setTransform(394.5,-207.8);
	...
	this.shape_46.setTransform(376.1,-207.7);
	...
	this.shape_47.setTransform(358.9,-207.8);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("#000000").s().p("AAdBJIgyhIQgJAJgDAiIgCAdIglAAIACggQADgeAIgNQAIgOAMgIIgigvIAtAAIApA7QALgIACgcIACgXIAkAAIgCARQgDAfgHANQgIAMgOAJIAsA+g");
	this.shape_48.setTransform(334.7,-207.7);
	...
	this.shape_49.setTransform(316.2,-207.7);
	...
	this.shape_50.setTransform(291,-207.8);
	...
	this.shape_51.setTransform(273.1,-207.8);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("#000000").s().p("Ag/AxQgXgYAAgyIgBgwIAmAAIAAAmIABAWIAAAJQAKAAAHgEQAHgFACgIQACgIABgSIACgaIAkAAIgCAkQgBAOgCAHQgCAIgFAIQgGAGgLAGQgNAFgTACQADALALAIQALAHAOAAQAWAAANgOQAMgOADglIAEg1IAlAAIgEA3QgDAigIARQgJARgTAMQgTAMgcAAQgnAAgWgZg");
	this.shape_52.setTransform(254.8,-207.5);
	...
	this.shape_53.setTransform(236.1,-207.8);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#000000").s().p("Ag/BkIAAiCIAmAAIAACCgAABAtIAAgaQAAgMADgHQACgIAJgLIAEgFQAGgKAAgPIAAgSIhYAAIAAggIB/AAIAAAlQAAAVgCAJQgBAKgGAHIgGAJQgHAJgCAGQgBAFAAAGIAAAZg");
	this.shape_54.setTransform(219.6,-204.9);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#000000").s().p("AglATIAAglIBLAAIAAAlg");
	this.shape_55.setTransform(207.4,-207.7);
	...
	this.shape_56.setTransform(-0.8,32.9);
	...
	this.shape_57.setTransform(-0.4,-116);
	...
	// Layer 1
	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#DAEDEF").s().p("EhHVAn3MAAAhPtMCOrAAAMAAABPtg");
	this.shape_59.setTransform(-0.6,11);
...
// stage content:
(lib.mfosesimbalalOfirMizrahiomerkarmi = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		function sabject(Coise) {
			if (Coise == 1) {
				...
				quition[0] = ["סרטים ישראלים", "סרטים שצולמו בישראל"];
				quition[1] = ["t", "מי מפחד מהזאב הרע", true, false, true];
				quition[2] = ["t", "פלאות", true, false, true];
				quition[3] = ["t", "גאליס המסע לאסטרה", true, false, true];
				quition[4] = ["t", "הלהקה האחרונה בלבנון", true, false, true];
				quition[5] = ["p", lib.move1, true, false, true];
				quition[6] = ["t", "שלושה שלטים מחוץ לאבינג, מיזורי", false, false, true];
				quition[7] = ["t", "הרץ במבוך תרופת המוות", false, false, true];
				quition[8] = ["t", "מלחמת הכוכבים אחרוני הג'דיי", false, false, true];
				quition[9] = ["t", "העדות", false, false, true];
				quition[10] = ["p", lib.move2, false, false, true];
				
				yesName = "סרטים שצולמו בישראל";
				noName = "סרטים שאינם צולמו בישראל";
		...
		function start1(evt) {
			...
			if (myvalue == 0) {
				myStart.but.alpha = 0.3;
				myStart.but.removeEventListener("click", startGame);
			} else {
				myStart.but.alpha = 1;
				myStart.but.addEventListener("click", startGame);
				myCoise = myvalue;
				//sabject(myCoise);
			...
			if (puse == false) {
				...
				var goStar = setInterval(function () {
					...
					if (star.x < -80) {
						...
						if (intersect(star, stage.getChildByName("carecter"))) {
							carecterBoom();
						}
					}
				}, runStar);
		...
		function carecterBoom() {
			...
			window.removeEventListener("keyup", stopMinets);
			window.removeEventListener("keydown", shot);
			var goPuse = setInterval(function () {
				goY = 0;
				var carecter = stage.getChildByName("carecter");
				var myGo = -1;
...
lib.properties = {
	...
	manifest: [
		...
		{src:"sounds/endSund.mp3", id:"endSund"},
		{src:"sounds/boom2mp3.mp3", id:"boom2mp3"},
		{src:"sounds/boom1mp3.mp3", id:"boom1mp3"},
